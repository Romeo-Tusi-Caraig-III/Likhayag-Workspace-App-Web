...
/// Global emerald color used throughout the page to avoid scope issues.
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _headerAnim = CurvedAnimation(parent: _animController, curve: Curves.easeOutQuart);
  ...
  Future<void> _onSignIn() async {
    ...
    // simulate request - replace with your real auth call
  ...
  Widget build(BuildContext context) {
    ...
    final double cardWidth = mq.size.width < 520 ? mq.size.width - 40 : 480;
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Sign in to continue to Name.App',
                                ...
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text('Remember me', style: TextStyle(color: Colors.grey[800])),
                                    ],
                                  ),
                                ),
                                TextButton(
                      ...
                      // SIGN UP LINK (plain text, emerald green, no underline)
                      Row(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Opacity(
              opacity: 0.12,
              child: Container(width: 160, height: 160, decoration: const BoxDecoration(color: Colors.white, shape: BoxShape.circle)),
            ),
          ),
          Positioned(
            left: -30,
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: prefix == null
            ...
            : Padding(
                ...
                child: IconTheme(data: IconThemeData(color: Colors.grey[700]), child: prefix!),
              ),
        suffixIcon: suffix,
        contentPadding: const EdgeInsets.symmetric(vertical: 16, horizontal: 14),
        enabledBorder: border,
        focusedBorder: border.copyWith(borderSide: BorderSide(color: kEmerald)),
