...
// Enhanced User Dashboard with admin_dashboard design (view-only)
...
class _UserDashboardPageState extends State<UserDashboardPage> with TickerProviderStateMixin {
  ...
  void _openCalendar() {
    try {
      Navigator.of(context).pushNamed('/user/calendar');
    } catch (e) {
      _showSnack('Failed to open calendar: $e', isError: true);
    }
  }

  void _openBudget() {
    try {
      Navigator.of(context).pushNamed('/user/budget');
    } catch (e) {
  ...
  void _openMeetings() {
    try {
      Navigator.of(context).pushNamed('/user/meetings');
    } catch (e) {
  ...
  void _openPlanner() {
    try {
      Navigator.of(context).pushNamed('/user/planner');
    } catch (e) {
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.school, color: _accentGreen, size: 24),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Good ${_morningAfternoonEvening()}, Student',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // View-only: Info badge instead of action button
            const SizedBox(height: 12),
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'View-only mode. Contact admin to schedule meetings.',
    ...
    return _modernCard(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _cardHeader(Icons.check_box, "My Tasks",
                trailing: TextButton.icon(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  decoration: status.toLowerCase() == 'completed'
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'View-only mode. Tasks are managed by your admin.',
                      style: TextStyle(color: Colors.blue.shade700, fontSize: 12),
                    ),
                  ),
                ],
  ...
  Widget _quickActionsCard() {
    final actions = [
      ...
      {'icon': Icons.event_note, 'label': 'Planner', 'fn': _openPlanner, 'color': Colors.purple},
  ...
  Drawer _buildDrawer() {
    final items = [
      ...
      {'icon': Icons.event_note, 'title': 'Planner', 'action': () { Navigator.pop(context); _openPlanner(); }},
