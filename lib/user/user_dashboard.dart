...
class _UserDashboardPageState extends State<UserDashboardPage> {
  ...
  // NEW: method to open Planner page
  void _openPlanner() {
    try {
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text('Good ${_morningAfternoonEvening()}, Student',
                            ...
                            itemBuilder: (ctx, i) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text('${meeting['location'] ?? ''} • ${meeting['time'] ?? ''}',
                                    style: const TextStyle(color: Color(0xFF6B7280))),
                                trailing: Icon(Icons.visibility, color: _accentGreen),
                              );
                            },
                            separatorBuilder: (ctx, _) => const Divider(height: 12),
                            itemCount: min(meetings.length, 5),
                          ),
              ),
            ),
          ],
              ...
              child: ConstrainedBox(
                ...
                child: _isLoading
                    ...
                    : filteredTasks.isEmpty
                        ...
                        : ListView.separated(
                            shrinkWrap: true,
                            itemCount: min(filteredTasks.length, 5),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 4),
                          Text('Student View', style: TextStyle(color: Colors.white70, fontSize: 13)),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _quickActionsCard() {
    final actions = [
      ...
      {'icon': Icons.event_note, 'label': 'Planner', 'fn': _openPlanner}, // NEW: Planner quick action
